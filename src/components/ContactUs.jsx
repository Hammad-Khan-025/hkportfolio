...
const ContactSection = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between p-8 md:py-20 bg-white max-w-6xl mx-auto ">
      {/* Left Side: Form */}
      <div className="w-full md:w-1/2 space-y-6">
        ...
        <form className="space-y-4 relative" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-[#138086] hover:bg-teal-800 text-white font-bold py-3 md:py-4 rounded transition-all active:scale-95 uppercase tracking-widest text-xs sm:text-sm cursor-pointer"
          >
            Submit
          </button>
