export default function SkillsSection() {
  const skills = ["HTML", "CSS", "Bootstrap", "Tailwind CSS", "Javascript", "ReactJS", "NextJS", "Firebase"];
    ...
    <section className="max-w-5xl mx-auto px-6 py-16">
      <div className="mb-10">
        <div className="flex justify-center sm:justify-start items-center gap-3 mb-2">
          ...
          <span className="text-teal-700 font-semibold uppercase tracking-wider text-sm">My Skills</span>
          <div className="h-[1px] w-8 bg-[#2d6a61]"></div>
        </div>
        <h2 className="text-3xl sm:text-4xl font-serif font-semibold text-[#138086] text-center sm:text-left mb-10 sm:mb-6">
        Technical Skills
        </h2>
        ...
        using the latest frontend technologies. My experience includes creating
        reusable UI components, integrating APIs, managing state, and deploying
        scalable applications with clean and maintainable code.
        </p>
      </div>
